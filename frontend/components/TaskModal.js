...
export default function TaskModal({ task, onClose, user, team, updateStatus, addComment }) {
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Title */}
        <h2 id="task-modal-title" className="text-xl font-semibold mb-3 truncate" title={task.task}>
          {task.task}
        </h2>
        ...
        {/* Footer */}
        <p className="text-xs text-gray-400 mt-3 border-t pt-2 select-none">{footerMessage}</p>
      </div>
    </div>
  );
}
